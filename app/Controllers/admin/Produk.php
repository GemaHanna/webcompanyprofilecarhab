...
class Produk extends BaseController
{
    ...
    public function proses_tambah()
    {
        ...
        // Buat slug otomatis untuk 'nama_produk_in'
        $slug_in = url_title($nama_produk_in, '-', true);
        // Buat slug otomatis untuk 'nama_produk_en'
