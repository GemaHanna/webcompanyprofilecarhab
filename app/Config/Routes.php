...
$routes->post('admin/meta/update/(:num)', 'admin\MetaController::update/$1');
$routes->get('admin/meta/delete/(:num)', 'admin\MetaController::delete/$1');
...
$routes->group('id', function ($routes) {
    ...
    $routes->get('produk/(:segment)', 'user\Productsctrl::detailBySlug/$1');
    // routes halaman aktivitas
    $routes->get('kegiatan', 'user\Aktivitasctrl::index');
    $routes->get('kegiatan/(:segment)', 'user\Aktivitasctrl::detailBySlug/$1');
    ...
    $routes->get('artikel/(:segment)', 'user\Artikelctrl::detailBySlug/$1');
});
...
$routes->group('en', function ($routes) {
    ...
    $routes->get('product/(:segment)', 'user\Productsctrl::detailBySlug/$1');
    // routes halaman aktivitas
    $routes->get('activities', 'user\Aktivitasctrl::index');
    $routes->get('activities/(:segment)', 'user\Aktivitasctrl::detailBySlug/$1');
    // routes halaman contact
    $routes->get('contact', 'user\Contactctrl::index');
    // end frond end routes
    // routes halaman artikel
    $routes->get('article', 'user\Artikelctrl::index');
    $routes->get('article/(:segment)', 'user\Artikelctrl::detailBySlug/$1');
});
