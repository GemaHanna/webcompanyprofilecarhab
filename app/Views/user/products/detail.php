    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-4 mb-lg-0" style="min-height: 500px; position: relative;">
                ...
                alt="<?= (session('lang') == 'en') ? $tbproduk->nama_produk_en : $tbproduk->nama_produk_in ?>">
            </div>
            <div class="col-lg-5 ml-auto">
                <h1 class="mb-3"><?= (session('lang') == 'en') ? $tbproduk->nama_produk_en : $tbproduk->nama_produk_in ?></h1>
                <p class="opacity-50 justify-text">
                    <?= (session('lang') == 'en') ? $tbproduk->deskripsi_produk_en : $tbproduk->deskripsi_produk_in ?>
                </p>
            </div>
        </div>
    </div>
