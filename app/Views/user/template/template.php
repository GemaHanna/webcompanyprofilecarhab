...
<head>
    ...
    <meta content="Free Website Template" name="description">
     ...
     <!-- Meta Tags -->
    <meta name="title" content="<?= $meta['meta_title'] ?? $tbaktivitas->meta_title ?? $tbproduk->meta_title ?? $artikel->meta_title ?? 'Default Title' ?>">
    <meta name="description" content="<?= $meta['meta_description'] ?? $tbaktivitas->meta_description ?? $tbproduk->meta_description ?? $artikel->meta_description ?? 'Default Description' ?>">

    <title><?= $meta['meta_title'] ?? $tbaktivitas->meta_title ?? $tbproduk->meta_title ?? $artikel->meta_title ?? 'Default Title' ?></title>
    <!-- Meta Canonical -->
    <link rel="canonical" href="<?= $canonicalUrl ?? 'https://default-url.com' ?>" />
    <!-- Favicon -->
