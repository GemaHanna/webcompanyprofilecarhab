...
<div class="app-content pt-3 p-md-3 p-lg-4">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control tiny" id="deskripsi_produk_in" name="deskripsi_produk_in"><?= $produkData->deskripsi_produk_in; ?></textarea>
    </div>

    <div class="mb-3">
        <label class="form-label">Deskripsi Produk (En)</label>
        <textarea class="form-control tiny" id="deskripsi_produk_en" name="deskripsi_produk_en"><?= $produkData->deskripsi_produk_en; ?></textarea>
    </div>
