                            ...
                            <div class="col">
                                <?php if (isset($artikelData)) : ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="judul_artikel_in" name="judul_artikel_in" value="<?= $artikelData->judul_artikel_in; ?>">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="meta_title" name="meta_title" value="<?= $artikelData->meta_title; ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Meta Deskripsi</label>
                                        <textarea type="text" class="form-control tiny" id="meta_deskripsi" name="meta_description"><?= $artikelData->meta_description; ?></textarea>
                                    </div>
                                    <div class="mb-3">
