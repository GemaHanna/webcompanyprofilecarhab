                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control tiny" id="meta_title" name="meta_title"><?= $aktivitasData->meta_title; ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Meta Deskripsi</label>
                                    <textarea type="text" class="form-control tiny" id="meta_description" name="meta_description"><?= $aktivitasData->meta_description; ?></textarea>
                                </div>
                                <div class="mb-3">
